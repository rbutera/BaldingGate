...
zip -r "$RELEASE_DIR/$RELEASE_NAME-$VERSION.zip" . -x "*.git*" "*.DS_Store" ".tmp.driveupload" ".tmp.driveupload/*" "_Logs" "_ErrorLogs" "BG3Config-Rai.cfg" "Screenshots" "Mods" "Harem Edition/*" "Harem Edition" "Mods/*"
